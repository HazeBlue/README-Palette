...
详细的配色方案请查看 [colors.md](colors.md) 文档。

</td>
<td width="50%">

Please refer to the [colors.md](colors.md) document for detailed color scheme information.
...
- [jQuery](https://jquery.com/) - JavaScript 库 / JavaScript Library
- [Google Fonts](https://fonts.google.com/) - 字体服务 / Font Service
- [Shields.io](https://shields.io/) - 徽章生成 / Badge Generation
